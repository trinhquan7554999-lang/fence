    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    <h1 class="display-6 mb-5">Welcome to FenceFixer Your fencing repair specialists</h1>
                    <div class="row g-4 mb-4">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 me-3" src="img/icon/icon-07-primary.png"
                                    alt="Expert Technician">
                                <h5 class="mb-0">Skilled Craftsmanship</h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 me-3" src="img/icon/icon-09-primary.png"
                                    alt="Best Quality Services">
                                <h5 class="mb-0">Reliable, Quality Repairs</h5>
                            </div>
                        </div>
                    </div>
                    <p class="mb-4">At FenceFixer we are experts at making your fence as good as new! Wood, Vinyl,
                        Chain-link, or Metal, our professional crew will repair your fence: on time, strictly adhering
                        to your budget, and to your satisfaction.</p>
